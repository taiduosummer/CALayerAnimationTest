...
//        view.addSubview(viewMask)
        ...
        leftLayer.frame = CGRectMake(0, 0, 100, 100)
        ...
        rightLayer.frame = CGRectMake(100, 0, 100, 100)
        ...
        let pathBese = UIBezierPath(arcCenter: CGPointMake(100, 100), radius: 90, startAngle: CGFloat(M_PI), endAngle: CGFloat(2 * M_PI), clockwise: true)
